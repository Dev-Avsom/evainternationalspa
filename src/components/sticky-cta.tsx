...
const StickyCTA = () => {
  ...
  return (
    <nav 
      className="fixed bottom-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-md shadow-luxury border-t border-border safe-area-bottom"
      aria-label="Quick contact"
      role="navigation"
    >
      <div className="flex gap-3 p-3">
        {/* Call Now Button - Deep Royal Blue, Pill shaped */}
        <Button
          onClick={handleCall}
          variant="call"
        ...
        {/* WhatsApp Button - Standard WhatsApp Green, Pill shaped */}
        <Button
