	...
	theme: {
		...
		extend: {
			colors: {
				...
				'gold-eva': 'hsl(var(--gold-eva))',
				'gold-eva-light': 'hsl(var(--gold-eva-light))',
				'gold-eva-dark': 'hsl(var(--gold-eva-dark))',
			...
			backgroundImage: {
				...
				'gradient-eva': 'var(--gradient-eva)',
				'gradient-eva-hero': 'var(--gradient-eva-hero)',
				'gradient-eva-card': 'var(--gradient-eva-card)',
			},
			boxShadow: {
